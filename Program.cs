...
namespace COMP003A.LectureActivity2
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //  another example of the three primary variable related activties ( derclaring, assigning, and retrieving)
            ...
            // the variable below are different despite having similar names 
             ...
             * there are eight integer types for storing integers of differing sizes and ranges: int, short, long, byte, sbyte, uint, and ulong.
            ...
            /* declaring,using, and concatenating characeters ans strings */
            char aLetter = 'A'; // character valyes are enclosed in single quotes
             ...
             * Multipication and subtraction are done first, left to right
             * Addition and subtraction are done last, left to right
             * Reference: https:// csharppplayersguide.com/articles/operators-table
             */
            ...
            arithmetic2 = 1 + 2; // assignig a second value to arithmetic2.
            ...
            // result: What is your name, human? Gursimran

            Console.WriteLine("Press any key when you're ready to begin.");
            Console.ReadKey(); // reads a keystroke

            Console.BackgroundColor = ConsoleColor.Yellow; // changes the console background to yelow
            ...
            Console.Beep(40, 1000); // computer beeps
        }
    }
}
